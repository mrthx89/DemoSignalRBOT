...
Namespace Repository
    Public Class Utils
        Public Shared Function SaveImage(ByVal img As Image, ByVal Path As String, ByVal FileName As String) As String
            Dim Hasil As String = ""
            Dim ImageSave As Bitmap = Nothing
            Try
